        ...
        return {
            "required": {
                "input_data_path": ("STRING", {"placeholder": "regression_input_data.csv", 
                                               "tooltip": "Path to the input data file"}), # Renamed for clarity
                "advanced": ("BOOLEAN", {"default": False, 
                                         "tooltip": "Advanced mode for more detailed settings"}),
            },
            "optional": {
                ...
                "use_filename_as_mol_name": ("BOOLEAN", {"default": True, 
                                                    "tooltip": "Use filename as molecule name"}),
                "retain_order": ("BOOLEAN", {"default": True, 
                                            "tooltip": "Retain order of input data"}),
                "threads": ("INT", {"default": 4, "min": 1, "max": CPU_COUNT, "step": 1,
                                    "tooltip": "Number of threads to use"}),
                "waiting_jobs": ("INT", {"default": 4, "min": 1, "max": CPU_COUNT, "step": 1,
                                    "tooltip": "Number of waiting jobs"}),
                "max_runtime": ("INT", {"default": 10000, "min": 1000, "max": 100000, "step": 1000,
                                    "tooltip": "Maximum runtime in seconds"}),
                "max_cpd_per_file": ("INT", {"default": 0, "min": 0, "max": 100000, "step": 1000,
                                    "tooltip": "Maximum compounds per file"}),
                "headless": ("BOOLEAN", {"default": True, 
                                    "tooltip": "Run in headless mode"}),
            },
        }
